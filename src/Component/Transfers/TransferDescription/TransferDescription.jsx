      ...
      <div className="transfer-description-container">
        ...
        <div className="general-information">
          <div className="generale-information-icon">
            ...
            <div><h4 style={{ fontSize: '18px' }}>General Information</h4></div>
          </div>
          <p>Remember to bring a printed copy of the voucher and valid photo
            ID with You after booking completion.</p>
        </div>
        {descriptionPageData.additionalDetails?.length > 0 &&
          <div className="general-information">
            <div className="generale-information-icon" style={{ paddingBottom: "10px" }}>
              <div><MdInfo style={{ fontSize: "24px" }} /></div>
              <div><h4 style={{ fontSize: '18px' }}>Vehicle Information</h4></div>
            </div>
            <p>{descriptionPageData.additionalDetails}</p>
          </div>
        }
